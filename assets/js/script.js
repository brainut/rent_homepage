(() => {
  ...
  const dict = {
    ...
    near_2_time:    { en: "5 min walk", ko: "도보 5분" },
    near_3_name:    { en: "Eulji Medical Center", ko: "을지병원" },
    near_3_time:    { en: "1 min walk", ko: "도보 1분" },
    near_4_name:    { en: "Seoul National University of Science & Technology", ko: "서울과학기술대학교" },
    near_4_time:    { en: "3 min drive", ko: "차량 3분" },
    near_5_name:    { en: "Jungnangcheon riverside path", ko: "중랑천 산책로" },
    near_5_time:    { en: "10 min walk", ko: "도보 10분" },
